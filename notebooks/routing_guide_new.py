...
# Install dependencies in Databricks if needed: %pip install vincenty networkx
...
# Old CombineLogicPP keeps top 10 candidates and final top 7 output paths.
COMBINED_TOP_N = 10
...
if not flight_only_rows:
    ...
    # Optional checkpoint after gateway filtering.
    # -------------------------------------------------------------------------
...
# CELL 32
# =============================================================================
# Project Payload final priority assignment
# =============================================================================
...
print(f"ForExportPP paths (from CombinedTop10): {ForExportPP.count()}")
